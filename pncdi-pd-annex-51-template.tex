...
\comment{\textbf{Anexa 5.1 -- Declarație privind încadrarea în definiția organizației de cercetare}}
...
\gendered{Subsemnatul}{Subsemnata} \placeholder*[15]{}\comment{(numele şi prenumele reprezentantului
legal al organizației de cercetare)}, în calitate de \placeholder*[15]{}\comment{(funcția
reprezentantului legal)} al \placeholder*[12]{}\comment{(denumirea completă a organizației
